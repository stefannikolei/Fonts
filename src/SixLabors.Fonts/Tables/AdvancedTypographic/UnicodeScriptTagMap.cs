...
internal sealed class UnicodeScriptTagMap : Dictionary<ScriptClass, Tag[]>
{
    ...
    private static UnicodeScriptTagMap CreateMap()
        => new()
        {
            ...
            { ScriptClass.Bengali, new[] { Tag.Parse("bng3"), Tag.Parse("bng2"), Tag.Parse("beng") } },
            ...
            { ScriptClass.Devanagari, new[] { Tag.Parse("dev3"), Tag.Parse("dev2"), Tag.Parse("deva") } },
            ...
            { ScriptClass.Gujarati, new[] { Tag.Parse("gjr3"), Tag.Parse("gjr2"), Tag.Parse("gujr") } },
            { ScriptClass.Gurmukhi, new[] { Tag.Parse("gur3"), Tag.Parse("gur2"), Tag.Parse("guru") } },
            ...
            { ScriptClass.Kannada, new[] { Tag.Parse("knd3"), Tag.Parse("knd2"), Tag.Parse("knda") } },
            ...
            { ScriptClass.Malayalam, new[] { Tag.Parse("mlm3"), Tag.Parse("mlm2"), Tag.Parse("mlym") } },
            ...
            { ScriptClass.Oriya, new[] { Tag.Parse("ory3"), Tag.Parse("ory2"), Tag.Parse("orya") } },
            ...
            { ScriptClass.Tamil, new[] { Tag.Parse("tml3"), Tag.Parse("tml2"), Tag.Parse("taml") } },
            { ScriptClass.Tangut, new[] { Tag.Parse("tang") } },
            { ScriptClass.TaiViet, new[] { Tag.Parse("tavt") } },
            { ScriptClass.Telugu, new[] { Tag.Parse("tel3"), Tag.Parse("tel2"), Tag.Parse("telu") } },
