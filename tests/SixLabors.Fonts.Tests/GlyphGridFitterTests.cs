...
public class GlyphGridFitterTests
{
    ...
    public void SnapsRectangleStemToWholePixels()
    {
        ...
        GridFitOptions options = new(8F, GridFitAxisMode.Full, GridFitAxisMode.None, [], [], [], 1F, 1F);
    ...
    public void VerticalPassSnapsBaselineAndXHeight()
    {
        ...
        GridFitOptions options = new(8F, GridFitAxisMode.None, GridFitAxisMode.Full, [4.6F], [], [], 1F, 1F);
    ...
    public void RescueWidensSubPixelStrokeToOnePixel()
    {
        ...
        GridFitOptions options = new(8F, GridFitAxisMode.None, GridFitAxisMode.Rescue, [], [], [], 1F, 1F);
